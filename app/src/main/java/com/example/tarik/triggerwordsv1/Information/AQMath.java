...
public class AQMath extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestion2.setText("Computing math shows dependence on finger counting and other tricks.");
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            case R.id.nextButton:
                setUp();
                Intent intent1 = new Intent(this, AQHandwriting.class);
    ...
    private void setUp() {
        ...
        if (this.getClass().getSimpleName().equals("AQMath")) {
            int screenNumber = 4;
        ...
        myAlert.setView(v)
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent2 = new Intent(AQMath.this, information.class);
