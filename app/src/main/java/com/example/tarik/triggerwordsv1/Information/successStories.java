...
public class successStories extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        contentText1TextA.setText("McQueen was promoting his award-winning movie when he talked for the first time " +
                "about his learning struggles. He shared that he has dyslexiaóand had hidden it for years out of shame. " +
                "ìI thought it meant I was stupid,î McQueen explained. His success spotlights how wrong he was. McQueenís "+
                "storytelling skills created a movie that received Oscarís top honor. And so far in his career, he has written, "+
        ...
        contentText1TextB.setText("Cruise spent his childhood trying to hide his dyslexia from his peers." +
                ...
                "Iíd try to concentrate on what I was reading, then Iíd get to the end of the page and have very little memory of anything Iíd read." +
                ...
                "says Tom Cruise. He could barely read in high school or through his earliest roles. " +
                "As he started to embrace his love of acting, Cruise realized that his inability to read would hold him back if he didnít work hard at it. " +
        ...
        contentText1TextC.setText("I grew up in a home where reading and writing had great value,î Cooper has said." +
                "His brother was ìa voracious reader,î always carrying a book around with him. So Cooper did the same." +
                "But he admits, ìI would just pretend to read it, because I had trouble reading and making sense of words, in particular, letters.î " +
                "ìTo a child with a learning disability, school can be an incredibly isolating place,î Cooper said. " +
                "But a school with understanding teachers changed that for him: ìIt made all the difference in my life early on. " +
                "And the good news is that there are great schools out there, able to provide the necessary resources and support.î " +
        ...
        contentText2TextA.setText("World heavy weight champion Muhammad Ali fought hard in the ring as well as the classroom. Diagnosed with dyslexia " +
                "at a young age, Ali struggled with reading. He barely graduated from high school and never felt smart. He hated reading, " +
                "but loved to fight. Ali grew up to become an incredible athlete, winning world championships and gold medals at the Olympics." +
        ...
        contentText2TextB.setText("Michelle Carter grew up with dyslexia and ADHD. Reading and spelling were a challenge for her (they still are), " +
                ...
                "It motivated her to do well enough in school to be able to continue competing. And it took her all the way to Rio in 2016, " +
                "where she won an Olympic gold medal in the shot put. Now sheís using her newfound fame and to help other children follow in her footsteps.");
        ...
        contentText2TextC.setText("Meryl began ice skating at the age of five and was diagnosed with dyslexia in third grade. While she shined on the ice, " +
                ...
                "Davis says her dyslexia is what helped her develop a remarkable character. ìI learned how I learned and how my brain worked.  It helped me adjust " +
                "and compensate for my differences. It opened me up to problem solving, seeing things differently, and how I can help myself overcome things.î, says Meryl.");
        ...
        contentText3TextA.setText("Lennon excelled at art and music while attending high school, but his grades were poor and he had trouble spelling. He was rowdy in the classroom and was called a troublemaker. " +
                ...
                "Some teachers noticed his difficulties with school and would encourage Lennon to express himself. Thus, Lennon let his talent shine through his music and writing to be come one of the legendary musicians or our time. His lyrics " +
        ...
        contentText3TextB.setText("Noel's school life was problematic at best. While he was plainly a bright\n" +
                ...
                "As the lead guitarist and songwriter for British rock band Oasis, Gallagherís dyslexia has the potential to stump his bandmates: ìWhen I write, Iíll give it " +
                "to someone else to read, and theyíll say, ëThis doesn't make any sense.í And then Iíll read it back to them, and theyíll say, ëHalf the words are missing.í But to me theyíre there.");
        ...
        contentText3TextC.setText("I never read in school. I got really bad grades--D's and F's and C's in some classes, and A's and B's in other classes. In the second week of the 11th grade, I just quit. " +
                "When I was in school, it was really difficult. Almost everything I learned, I had to learn by listening. My report cards always said that I was not living up to my potential.\"- Cher " +
                "Cher struggled with reading all through grade school, and at age 16, she dropped out. Though she found out at age 30 that she had dyslexia, Cher went untested in grade school and her dyslexia was " +
                "unrecognizedómany teachers thought she wasnít trying. Cher also was successful on her own. She recorded hits such as \"If I Could Turn Back Time,\" \"Believe,\" and \"I Found Someone.\" She also became an actress " +
                "and starred in Mask and the 2010 movie Burlesque. Her dyslexia may slow her down in reading, but it didnít hinder her from becoming a great actress and singer.");
