...
public class AQAttentionFocus extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aqattentionfocus);
        ...
        mQuestion2.setText("Excellent long-term memory for experiences, locations, or faces. Poor memory for sequences or information that has not been experienced.");
        mQuestion3.setText("Thinks primarily with images and feeling, not sounds or words (little internal dialogue)");
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            case R.id.nextButton:
                setUp();
                Intent intent1 = new Intent(this, AQMath.class);
    ...
    private void setUp() {
        ...
        if (this.getClass().getSimpleName().equals("AQAttentionFocus")) {
            int screenNumber = 3;
